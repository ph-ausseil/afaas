...
def copy_file(source_path: Path, destination_path: Path, task: Task, agent: BaseAgent) -> str:
...
def move_file(source_path: Path, destination_path: Path, task: Task, agent: BaseAgent) -> str:
...
def create_link(source_path: Path, link_path: Path, task: Task, agent: BaseAgent) -> str:
...
def create_symlink(source_path: Path, link_path: Path, task: Task, agent: BaseAgent) -> str:
...
def synchronize_directories(source_directory: Path, destination_directory: Path, task: Task, agent: BaseAgent) -> str:
...
def change_ownership(path: Path, uid: int, gid: int, task: Task, agent: BaseAgent) -> str:
