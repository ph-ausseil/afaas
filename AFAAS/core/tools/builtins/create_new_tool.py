      ...
      parameters= {
                ...
                "properties": {
                    "function_description": {
                        ...
                        "properties": {
                            "name": {"type": "string", "description": "The name of the function to be created"},
                            ...
                            "new_config_keys": {
                                ...
                                "items": {
                                    "type": "object",
                                    "properties": {
                                        "key": {"type": "string", "description": 'The key name to be added; in the format TOOL_NAMEOFUNCTION_NAMEOFKEY'},
                                        "description": {"type": "string", "description": "Description of the new  key"},
                                    },
...
def create_new_tool(self, function_description ):
    # Import statements
    imports = '\n'.join(f'import {module}' for module in function_description['imports'])

    # Adding new config keys
    new_config_keys = '\n    '.join(f"# {key['description']}\n    config['{key['key']}'] = None" for key in function_description.get('new_config_keys', []))
...
{body}
    ...
    # Load the module
    spec = importlib.util.spec_from_file_location(function_description['name'], file_path)
