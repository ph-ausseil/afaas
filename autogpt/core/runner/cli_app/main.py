...
async def run_auto_gpt(user_configuration: dict):
    ...
    if agent_dict_list:
        ...
        client_logger.info(f"Loading agent {agent_id} from get_agentsetting_list_from_memory") 
        ...
        client_logger.info(f"Comparing agents from agent list and get_agent_from_memory")   
